    ...
    <>
      {editor && (
        <button
          ...
          className="fixed bottom-20 right-4 md:bottom-4 z-50 text-[10px] uppercase tracking-widest text-neutral-300 hover:text-neutral-500 transition-colors cursor-pointer"
        >
          lock
        </button>
      )}
